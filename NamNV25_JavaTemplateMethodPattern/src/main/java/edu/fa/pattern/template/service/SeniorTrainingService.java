...
public class SeniorTrainingService extends TrainingService {

	@Override
	void verity(String applicationId) {
		// TODO Auto-generated method stub
		System.out.println("Verity Senior " + applicationId);
	}

	@Override
	void enroll(String candidateName) {
		// TODO Auto-generated method stub
		System.out.println("Enroll Senior " + candidateName);
	}
}
